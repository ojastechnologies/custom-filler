    ...
    <footer className="bg-gray-100 dark:bg-gray-900 pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            {/* <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-4">Aero Tech Labs</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              A small, dedicated, and ambitious aerosol custom filling facility located in South Florida.
            </p>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/policies/shipping" className="hover:text-primary-400 transition-colors">
                  Shipping Policy
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/policies/returns" className="hover:text-primary-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/about-us" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/faqs" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400">
                  FAQs
                </Link>
              </li>
              <li>
                <Link href="/contact-us" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-4">Products and Services</h3>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link href="/envirolase-laser-cryogen-coolant" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400">
                  Laser Cryogen
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 mt-8 pt-8 text-center text-gray-600 dark:text-gray-400">
          <p>© {new Date().getFullYear()} Aero Tech Labs. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
