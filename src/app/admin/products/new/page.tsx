...
export default function AdminNewProductPage() {
  ...
  // // Either use imagePreview or remove it
  // // If you want to keep it for future use, make sure it's used somewhere in the component
  // // For example, in the image preview section
  ...
  //   // Use setImagePreview when the image URL changes
  //   if (name === 'image') {
  ...
  //                       <NextImage 
  //                         src={imagePreview || formData.image || '/placeholder-product.jpg'} 
  //                         alt="Product preview"
  //                         width={200}
  //                         height={200}
