...
export const metadata = {
  title: 'Privacy Policy | Custom Filler',
  description: 'Our privacy policy and how we handle your personal information at Custom Filler.'
};
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Our website address is: <a href="https://customfiller.com" className="text-primary-600 dark:text-primary-400 hover:underline">https://customfiller.com</a>.
              </p>
            </div>
